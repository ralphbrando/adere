...
import 'adere_dashboard_mes_informations_dev_model.dart';
export 'adere_dashboard_mes_informations_dev_model.dart';

class AdereDashboardMesInformationsDevWidget extends StatefulWidget {
  const AdereDashboardMesInformationsDevWidget({super.key});

  @override
  State<AdereDashboardMesInformationsDevWidget> createState() =>
      _AdereDashboardMesInformationsDevWidgetState();
}

class _AdereDashboardMesInformationsDevWidgetState
    extends State<AdereDashboardMesInformationsDevWidget> {
  late AdereDashboardMesInformationsDevModel _model;
  ...
  void initState() {
    super.initState();
    _model =
        createModel(context, () => AdereDashboardMesInformationsDevModel());

    logFirebaseEvent('screen_view',
        parameters: {'screen_name': 'ADERE_DASHBOARD_MES_INFORMATIONS_DEV'});
