...
import 'adere_presentation2_dev_model.dart';
export 'adere_presentation2_dev_model.dart';

class AderePresentation2DevWidget extends StatefulWidget {
  const AderePresentation2DevWidget({super.key});

  @override
  State<AderePresentation2DevWidget> createState() =>
      _AderePresentation2DevWidgetState();
}

class _AderePresentation2DevWidgetState
    extends State<AderePresentation2DevWidget> {
  late AderePresentation2DevModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => AderePresentation2DevModel());

    logFirebaseEvent('screen_view',
        parameters: {'screen_name': 'ADERE_PRESENTATION_2_DEV'});
