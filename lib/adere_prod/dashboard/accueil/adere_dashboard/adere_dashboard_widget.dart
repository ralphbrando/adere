...
import 'adere_dashboard_model.dart';
export 'adere_dashboard_model.dart';

class AdereDashboardWidget extends StatefulWidget {
  const AdereDashboardWidget({super.key});

  @override
  State<AdereDashboardWidget> createState() => _AdereDashboardWidgetState();
}

class _AdereDashboardWidgetState extends State<AdereDashboardWidget>
    with TickerProviderStateMixin {
  late AdereDashboardModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => AdereDashboardModel());

    logFirebaseEvent('screen_view',
        parameters: {'screen_name': 'ADERE_DASHBOARD'});
    // On page load action.
    SchedulerBinding.instance.addPostFrameCallback((_) async {
      logFirebaseEvent('ADERE_DASHBOARD_ADERE_DASHBOARD_ON_INIT_');
      logFirebaseEvent('ADERE_DASHBOARD_update_app_state');
      ...
      FFAppState().deviceId = currentUserUid;
      safeSetState(() {});
      logFirebaseEvent('ADERE_DASHBOARD_backend_call');
      ...
      if (_model.userData!.first.onboardingLevel! < 7) {
        logFirebaseEvent('ADERE_DASHBOARD_update_app_state');
        FFAppState().onboardLevel = _model.userData!.first.onboardingLevel!;
        safeSetState(() {});
        logFirebaseEvent('ADERE_DASHBOARD_navigate_to');

        context.pushNamed('ADERE_PROGRAMME_INITIAL');
      } else {
        logFirebaseEvent('ADERE_DASHBOARD_update_app_state');
        FFAppState().onboardLevel = _model.userData!.first.onboardingLevel!;
        safeSetState(() {});
                              ...
                              child: Row(
                                ...
                                children: [
                                  Expanded(
                                    child: Align(
                                      alignment: AlignmentDirectional(0.0, 0.0),
                                      child: FutureBuilder<List<ProgrammesRow>>(
                                        future: ProgrammesTable().queryRows(
                                          queryFn: (q) => q.order('position',
                                              ascending: true),
                                        ),
                                        builder: (context, snapshot) {
                                          ...
                                          List<ProgrammesRow>
                                              programmesListViewProgrammesRowList =
                                              snapshot.data!;
                                          ...
                                          return ListView.separated(
                                            ...
                                            separatorBuilder: (_, __) =>
                                                SizedBox(width: 20.0),
                                            itemBuilder: (context,
                                                programmesListViewIndex) {
                                              final programmesListViewProgrammesRow =
                                                  programmesListViewProgrammesRowList[
                                                      programmesListViewIndex];
                                              return Container(
                                                width: 155.0,
                                                ...
                                                child: InkWell(
                                                  ...
                                                  onTap: () async {
                                                    logFirebaseEvent(
                                                        'ADERE_DASHBOARD_Programme_Column_ON_TAP');
                                                    logFirebaseEvent(
                                                        'Programme_Column_navigate_to');
                                                    ...
                                                    context.pushNamed(
                                                      ...
                                                      queryParameters: {
                                                        'sequence':
                                                            serializeParam(
                                                          programmesListViewProgrammesRow
                                                              .id,
                                                          ParamType.int,
                                                        ),
                                                      }.withoutNulls,
                                    ...
                                    children: [
                                      Padding(
                                        ...
                                        child: InkWell(
                                          ...
                                          onTap: () async {
                                            logFirebaseEvent(
                                                'ADERE_DASHBOARD_Action_Container_ON_TAP');
                                            logFirebaseEvent(
                                                'Action_Container_navigate_to');
                                                    ...
                                                    child: Padding(
                                                      ...
                                                      child: Container(
                                                        ...
                                                        child: Column(
                                                          ...
                                                          children: [
                                                            Text(
                                                              'N\'oubliez pas de saisir vos médicaments du jour',
                                                    ...
                                                    child: Padding(
                                                      ...
                                                      child: Container(
                                                        ...
                                                        child: Column(
                                                          ...
                                                          children: [
                                                            Text(
                                                              'Continuer le programme découverte',
                                                              style: FlutterFlowTheme
                                                                      .of(context)
                                                                  .bodyMedium
                                                                  .override(
