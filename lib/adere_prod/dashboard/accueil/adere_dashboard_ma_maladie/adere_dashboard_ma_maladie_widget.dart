...
import 'adere_dashboard_ma_maladie_model.dart';
export 'adere_dashboard_ma_maladie_model.dart';

class AdereDashboardMaMaladieWidget extends StatefulWidget {
  const AdereDashboardMaMaladieWidget({super.key});

  @override
  State<AdereDashboardMaMaladieWidget> createState() =>
      _AdereDashboardMaMaladieWidgetState();
}

class _AdereDashboardMaMaladieWidgetState
    extends State<AdereDashboardMaMaladieWidget> {
  late AdereDashboardMaMaladieModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => AdereDashboardMaMaladieModel());

    logFirebaseEvent('screen_view',
        parameters: {'screen_name': 'ADERE_DASHBOARD_MA_MALADIE'});
    // On page load action.
    SchedulerBinding.instance.addPostFrameCallback((_) async {
      logFirebaseEvent('ADERE_DASHBOARD_MA_MALADIE_ADERE_DASHBOA');
      logFirebaseEvent('ADERE_DASHBOARD_MA_MALADIE_update_app_st');
                    ...
                    children: [
                              ...
                              Expanded(
                                child: FutureBuilder<List<UserIllnessRow>>(
                                  ...
                                  builder: (context, snapshot) {
                                    ...
                                    List<UserIllnessRow>
                                        textContainerUserIllnessRowList =
                                        snapshot.data!;
                                    ...
                                    return Container(
                                      ...
                                      child: Column(
                                        ...
                                        children: [
                                          Text(
                                            'Vous avez ${textContainerUserIllnessRowList.length.toString()} maladie(s) chronique(s).',
                      ...
                      Container(
                        ...
                        child: FutureBuilder<List<UserIllnessRow>>(
                          ...
                          builder: (context, snapshot) {
                            ...
                            List<UserIllnessRow>
                                maladiesListViewUserIllnessRowList =
                                snapshot.data!;
                            ...
                            return ListView.separated(
                              ...
                              itemCount:
                                  maladiesListViewUserIllnessRowList.length,
                              separatorBuilder: (_, __) =>
                                  SizedBox(height: 20.0),
                              itemBuilder: (context, maladiesListViewIndex) {
                                final maladiesListViewUserIllnessRow =
                                    maladiesListViewUserIllnessRowList[
                                        maladiesListViewIndex];
                                return Builder(
                                  builder: (context) => Padding(
                                    ...
                                    child: InkWell(
                                      ...
                                      onLongPress: () async {
                                        logFirebaseEvent(
                                            'ADERE_DASHBOARD_MA_MALADIE_Maladie_Conta');
                                        logFirebaseEvent(
                                            'Maladie_Container_alert_dialog');
                                        await showDialog(
                                          context: context,
                                              ...
                                              child: GestureDetector(
                                                onTap: () =>
                                                    FocusScope.of(dialogContext)
                                                        .unfocus(),
                                                child: SupprimerMaladieWidget(
                                                  action: () async {
                                                    logFirebaseEvent(
                                                        '_backend_call');
                                                    await UserIllnessTable()
                                                        .delete(
                                                      matchingRows: (rows) =>
                                                          rows.eq(
                                                        'id',
                                                        maladiesListViewUserIllnessRow
                                                            .id,
                                                      ),
                                                    );
                                                    logFirebaseEvent(
                      ...
                      Padding(
                        ...
                        child: InkWell(
                          ...
                          onTap: () async {
                            logFirebaseEvent(
                                'ADERE_DASHBOARD_MA_MALADIE_Button_Contai');
                            logFirebaseEvent(
                                'Button_Container_update_app_state');
                            FFAppState().dropdownVisibility = 0;
                            safeSetState(() {});
