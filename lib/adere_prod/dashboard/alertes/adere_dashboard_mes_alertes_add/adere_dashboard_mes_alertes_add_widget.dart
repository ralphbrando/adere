...
import 'adere_dashboard_mes_alertes_add_model.dart';
export 'adere_dashboard_mes_alertes_add_model.dart';

class AdereDashboardMesAlertesAddWidget extends StatefulWidget {
  const AdereDashboardMesAlertesAddWidget({super.key});

  @override
  State<AdereDashboardMesAlertesAddWidget> createState() =>
      _AdereDashboardMesAlertesAddWidgetState();
}

class _AdereDashboardMesAlertesAddWidgetState
    extends State<AdereDashboardMesAlertesAddWidget> {
  late AdereDashboardMesAlertesAddModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => AdereDashboardMesAlertesAddModel());

    logFirebaseEvent('screen_view',
        parameters: {'screen_name': 'ADERE_DASHBOARD_MES_ALERTES_ADD'});
    // On page load action.
    SchedulerBinding.instance.addPostFrameCallback((_) async {
      logFirebaseEvent('ADERE_DASHBOARD_MES_ALERTES_ADD_ADERE_DA');
      logFirebaseEvent('ADERE_DASHBOARD_MES_ALERTES_ADD_update_a');
                    ...
                    children: [
                                    ...
                                    Expanded(
                                      child: Container(
                                        ...
                                        child: Column(
                                          ...
                                          children: [
                                            Text(
                                              'Ajouter une alerte personnelle dans mon tableau de bord :',
                                  ...
                                  child: Column(
                                    ...
                                    children: [
                                      Container(
                                        ...
                                        child:
                                            FutureBuilder<List<AlertTypesRow>>(
                                          future: AlertTypesTable().queryRows(
                                            ...
                                            return FlutterFlowDropDown<String>(
                                              controller: _model
                                                  ...
                                                  FormFieldController<String>(
                                                      null),
                                              options: dropDownAlertTypesRowList
                                                  .map((e) => e.name)
                                                  .withoutNulls
                                                  .toList(),
                                      ...
                                      Container(
                                        ...
                                        child: InkWell(
                                          ...
                                          onTap: () async {
                                            logFirebaseEvent(
                                                'ADERE_DASHBOARD_MES_ALERTES_ADD_Field_Co');
                                            logFirebaseEvent(
                                                'Field_Column_date_time_picker');
                      ...
                      Padding(
                        ...
                        child: InkWell(
                          ...
                          onTap: () async {
                            logFirebaseEvent(
                                'ADERE_DASHBOARD_MES_ALERTES_ADD_Button_C');
