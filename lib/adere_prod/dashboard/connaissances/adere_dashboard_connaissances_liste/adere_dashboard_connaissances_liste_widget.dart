...
import 'adere_dashboard_connaissances_liste_model.dart';
export 'adere_dashboard_connaissances_liste_model.dart';

class AdereDashboardConnaissancesListeWidget extends StatefulWidget {
  const AdereDashboardConnaissancesListeWidget({
    super.key,
  ...
  @override
  State<AdereDashboardConnaissancesListeWidget> createState() =>
      _AdereDashboardConnaissancesListeWidgetState();
}

class _AdereDashboardConnaissancesListeWidgetState
    extends State<AdereDashboardConnaissancesListeWidget> {
  late AdereDashboardConnaissancesListeModel _model;
  ...
  void initState() {
    super.initState();
    _model =
        createModel(context, () => AdereDashboardConnaissancesListeModel());

    logFirebaseEvent('screen_view',
        parameters: {'screen_name': 'ADERE_DASHBOARD_CONNAISSANCES_LISTE'});
    // On page load action.
    SchedulerBinding.instance.addPostFrameCallback((_) async {
      logFirebaseEvent('ADERE_DASHBOARD_CONNAISSANCES_LISTE_ADER');
      logFirebaseEvent('ADERE_DASHBOARD_CONNAISSANCES_LISTE_upda');
                    ...
                    children: [
                      ...
                      Padding(
                        ...
                        child: Container(
                          ...
                          child: FutureBuilder<List<WikiPostsRow>>(
                            future: WikiPostsTable().queryRows(
                              queryFn: (q) => q
                                  .eq(
                                    'wikicategory',
                                    widget!.catid,
                            ...
                            builder: (context, snapshot) {
                              ...
                              List<WikiPostsRow>
                                  themesListViewWikiPostsRowList =
                                  snapshot.data!;
                              ...
                              return ListView.separated(
                                ...
                                itemCount:
                                    themesListViewWikiPostsRowList.length,
                                separatorBuilder: (_, __) =>
                                    SizedBox(height: 20.0),
                                itemBuilder: (context, themesListViewIndex) {
                                  final themesListViewWikiPostsRow =
                                      themesListViewWikiPostsRowList[
                                          themesListViewIndex];
                                  return Container(
                                    width: double.infinity,
                                    ...
                                    child: Column(
                                      ...
                                      children: [
                                        InkWell(
                                          ...
                                          onTap: () async {
                                            logFirebaseEvent(
                                                'ADERE_DASHBOARD_CONNAISSANCES_LISTE_Them');
                                            logFirebaseEvent(
                                                'Theme_Wrap_Container_navigate_to');

                                            context.pushNamed(
                                              'ADERE_DASHBOARD_CONNAISSANCES_ARTICLE',
                                              queryParameters: {
                                                'idart': serializeParam(
                                                  themesListViewWikiPostsRow.id,
                                                  ParamType.int,
                                                ),
                                              }.withoutNulls,
                                            );
