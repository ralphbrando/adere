...
import 'adere_dashboard_menu_model.dart';
export 'adere_dashboard_menu_model.dart';

class AdereDashboardMenuWidget extends StatefulWidget {
  const AdereDashboardMenuWidget({super.key});

  @override
  State<AdereDashboardMenuWidget> createState() =>
      _AdereDashboardMenuWidgetState();
}

class _AdereDashboardMenuWidgetState extends State<AdereDashboardMenuWidget> {
  late AdereDashboardMenuModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => AdereDashboardMenuModel());

    logFirebaseEvent('screen_view',
        parameters: {'screen_name': 'ADERE_DASHBOARD_MENU'});
    // On page load action.
    SchedulerBinding.instance.addPostFrameCallback((_) async {
      logFirebaseEvent('ADERE_DASHBOARD_MENU_ADERE_DASHBOARD_MEN');
      logFirebaseEvent('ADERE_DASHBOARD_MENU_update_app_state');
