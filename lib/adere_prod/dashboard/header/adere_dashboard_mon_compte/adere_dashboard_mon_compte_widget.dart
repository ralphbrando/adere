...
import 'adere_dashboard_mon_compte_model.dart';
export 'adere_dashboard_mon_compte_model.dart';

class AdereDashboardMonCompteWidget extends StatefulWidget {
  const AdereDashboardMonCompteWidget({super.key});

  @override
  State<AdereDashboardMonCompteWidget> createState() =>
      _AdereDashboardMonCompteWidgetState();
}

class _AdereDashboardMonCompteWidgetState
    extends State<AdereDashboardMonCompteWidget> {
  late AdereDashboardMonCompteModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => AdereDashboardMonCompteModel());

    logFirebaseEvent('screen_view',
        parameters: {'screen_name': 'ADERE_DASHBOARD_MON_COMPTE'});
    // On page load action.
    SchedulerBinding.instance.addPostFrameCallback((_) async {
      logFirebaseEvent('ADERE_DASHBOARD_MON_COMPTE_ADERE_DASHBOA');
      logFirebaseEvent('ADERE_DASHBOARD_MON_COMPTE_update_app_st');
