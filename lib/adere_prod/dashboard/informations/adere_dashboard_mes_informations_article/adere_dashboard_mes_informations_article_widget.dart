...
import 'adere_dashboard_mes_informations_article_model.dart';
export 'adere_dashboard_mes_informations_article_model.dart';

class AdereDashboardMesInformationsArticleWidget extends StatefulWidget {
  const AdereDashboardMesInformationsArticleWidget({super.key});

  @override
  State<AdereDashboardMesInformationsArticleWidget> createState() =>
      _AdereDashboardMesInformationsArticleWidgetState();
}

class _AdereDashboardMesInformationsArticleWidgetState
    extends State<AdereDashboardMesInformationsArticleWidget> {
  late AdereDashboardMesInformationsArticleModel _model;
  ...
  void initState() {
    super.initState();
    _model =
        createModel(context, () => AdereDashboardMesInformationsArticleModel());
    ...
    SchedulerBinding.instance.addPostFrameCallback((_) async {
      logFirebaseEvent('ADERE_DASHBOARD_MES_INFORMATIONS_ARTICLE');
      logFirebaseEvent('ADERE_DASHBOARD_MES_INFORMATIONS_ARTICLE');
