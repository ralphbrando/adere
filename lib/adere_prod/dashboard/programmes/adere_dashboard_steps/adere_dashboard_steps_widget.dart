...
import 'adere_dashboard_steps_model.dart';
export 'adere_dashboard_steps_model.dart';

class AdereDashboardStepsWidget extends StatefulWidget {
  const AdereDashboardStepsWidget({
    super.key,
  ...
  @override
  State<AdereDashboardStepsWidget> createState() =>
      _AdereDashboardStepsWidgetState();
}

class _AdereDashboardStepsWidgetState extends State<AdereDashboardStepsWidget> {
  late AdereDashboardStepsModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => AdereDashboardStepsModel());

    logFirebaseEvent('screen_view',
        parameters: {'screen_name': 'ADERE_DASHBOARD_STEPS'});
    // On page load action.
    SchedulerBinding.instance.addPostFrameCallback((_) async {
      logFirebaseEvent('ADERE_DASHBOARD_STEPS_ADERE_DASHBOARD_ST');
      logFirebaseEvent('ADERE_DASHBOARD_STEPS_update_app_state');
      ...
      safeSetState(() {});
      logFirebaseEvent('ADERE_DASHBOARD_STEPS_backend_call');
      _model.apiResultvf5 = await ApiAdereGroup.apiStepsCall.call(
        deviceId: currentUserUid,
        id: widget!.sequence?.toString(),
        phaseId: widget!.phase?.toString(),
      );
    });
          ...
          children: [
                    ...
                    children: [
                                ...
                                Expanded(
                                  child: Container(
                                    ...
                                    child: Column(
                                      ...
                                      children: [
                                        Text(
                                          'La liste des étapes de votre phase.',
                                          style: FlutterFlowTheme.of(context)
                                              .bodyMedium
                                              .override(
                                                fontFamily: 'Inter',
                      ...
                      Container(
                        ...
                        child: FutureBuilder<ApiCallResponse>(
                          future: ApiAdereGroup.apiStepsCall.call(
                            deviceId: currentUserUid,
                            id: widget!.sequence?.toString(),
                            phaseId: widget!.phase?.toString(),
                          ),
                          builder: (context, snapshot) {
                            ...
                            final stepsListViewApiStepsResponse =
                                snapshot.data!;

                            return Builder(
                              builder: (context) {
                                final step = ApiAdereGroup.apiStepsCall
                                        .steps(
                                          stepsListViewApiStepsResponse
                                              .jsonBody,
                                        )
                                        ?.toList() ??
                                    [];
            ...
            Padding(
              ...
              child: InkWell(
                ...
                onTap: () async {
                  logFirebaseEvent('ADERE_DASHBOARD_STEPS_Button_Container_O');
