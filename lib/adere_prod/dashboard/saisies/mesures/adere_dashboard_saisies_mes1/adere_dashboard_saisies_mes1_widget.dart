...
import 'adere_dashboard_saisies_mes1_model.dart';
export 'adere_dashboard_saisies_mes1_model.dart';

class AdereDashboardSaisiesMes1Widget extends StatefulWidget {
  const AdereDashboardSaisiesMes1Widget({super.key});

  @override
  State<AdereDashboardSaisiesMes1Widget> createState() =>
      _AdereDashboardSaisiesMes1WidgetState();
}

class _AdereDashboardSaisiesMes1WidgetState
    extends State<AdereDashboardSaisiesMes1Widget> {
  late AdereDashboardSaisiesMes1Model _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => AdereDashboardSaisiesMes1Model());

    logFirebaseEvent('screen_view',
        parameters: {'screen_name': 'ADERE_DASHBOARD_SAISIES_MES1'});
    // On page load action.
    SchedulerBinding.instance.addPostFrameCallback((_) async {
      logFirebaseEvent('ADERE_DASHBOARD_SAISIES_MES1_ADERE_DASHB');
      logFirebaseEvent('ADERE_DASHBOARD_SAISIES_MES1_update_app_');
                    ...
                    children: [
                          ...
                          child: Row(
                            ...
                            children: [
                              InkWell(
                                ...
                                onTap: () async {
                                  logFirebaseEvent(
                                      'ADERE_DASHBOARD_SAISIES_MES1_Icon_Contai');
                                  logFirebaseEvent(
                      ...
                      Padding(
                        ...
                        child: InkWell(
                          ...
                          onTap: () async {
                            logFirebaseEvent(
                                'ADERE_DASHBOARD_SAISIES_MES1_Button_Cont');
                            logFirebaseEvent('Button_Container_navigate_to');

                            context.pushNamed('ADERE_DASHBOARD_SAISIES_MES2');
                          },
                          child: Container(
                            width: double.infinity,
                            decoration: BoxDecoration(
                      ...
                      Container(
                        width: double.infinity,
                        decoration: BoxDecoration(),
                        child: FutureBuilder<List<SaisieParametersRow>>(
                          future: SaisieParametersTable().queryRows(
                            queryFn: (q) => q
                                .eq(
                                  'user',
                                  currentUserUid,
                          ...
                          builder: (context, snapshot) {
                            ...
                            List<SaisieParametersRow>
                                mesuresColumnSaisieParametersRowList =
                                snapshot.data!;

                            return Column(
                              mainAxisSize: MainAxisSize.max,
                              children: List.generate(
                                  mesuresColumnSaisieParametersRowList.length,
                                  (mesuresColumnIndex) {
                                final mesuresColumnSaisieParametersRow =
                                    mesuresColumnSaisieParametersRowList[
                                        mesuresColumnIndex];
                                return Padding(
                                  padding: EdgeInsetsDirectional.fromSTEB(
                                  ...
                                  child: Container(
                                    ...
                                    child: FutureBuilder<List<ParametersRow>>(
                                      future: ParametersTable().querySingleRow(
                                        queryFn: (q) => q.eq(
                                          'name',
                                          mesuresColumnSaisieParametersRow
                                              .parameter,
                                        ),
                                      ),
                                      builder: (context, snapshot) {
                                        ...
                                        List<ParametersRow>
                                            mesureColumnParametersRowList =
                                            snapshot.data!;

                                        final mesureColumnParametersRow =
                                            mesureColumnParametersRowList
                                                    .isNotEmpty
                                                ? mesureColumnParametersRowList
                                                    .first
                                                  ...
                                                  Expanded(
                                                    child: Container(
                                                      ...
                                                      child: ListView(
                                                        ...
                                                        children: [
                                                          Text(
                                                            '${mesuresColumnSaisieParametersRow.value} ${mesureColumnParametersRow?.unit}',
                                                            textAlign:
                                                                TextAlign.start,
                                                            style: FlutterFlowTheme
                                                                    .of(context)
