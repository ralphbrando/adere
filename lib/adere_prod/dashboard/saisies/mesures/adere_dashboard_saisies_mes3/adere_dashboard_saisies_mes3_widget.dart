...
import 'adere_dashboard_saisies_mes3_model.dart';
export 'adere_dashboard_saisies_mes3_model.dart';

class AdereDashboardSaisiesMes3Widget extends StatefulWidget {
  const AdereDashboardSaisiesMes3Widget({
    super.key,
    required this.param,
  });
  ...
  @override
  State<AdereDashboardSaisiesMes3Widget> createState() =>
      _AdereDashboardSaisiesMes3WidgetState();
}

class _AdereDashboardSaisiesMes3WidgetState
    extends State<AdereDashboardSaisiesMes3Widget> {
  late AdereDashboardSaisiesMes3Model _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => AdereDashboardSaisiesMes3Model());

    logFirebaseEvent('screen_view',
        parameters: {'screen_name': 'ADERE_DASHBOARD_SAISIES_MES3'});
    // On page load action.
    SchedulerBinding.instance.addPostFrameCallback((_) async {
      logFirebaseEvent('ADERE_DASHBOARD_SAISIES_MES3_ADERE_DASHB');
      logFirebaseEvent('ADERE_DASHBOARD_SAISIES_MES3_update_app_');
                    ...
                    children: [
                      ...
                      Padding(
                        ...
                        child: InkWell(
                          ...
                          onTap: () async {
                            logFirebaseEvent(
                                'ADERE_DASHBOARD_SAISIES_MES3_Button_Cont');
                            ...
                            context.pushNamed('ADERE_DASHBOARD_SAISIES_MES4');
                          },
                          child: Container(
                            width: double.infinity,
                            decoration: BoxDecoration(
