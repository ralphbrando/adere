...
import 'adere_dashboard_saisies_s4_model.dart';
export 'adere_dashboard_saisies_s4_model.dart';

class AdereDashboardSaisiesS4Widget extends StatefulWidget {
  const AdereDashboardSaisiesS4Widget({super.key});

  @override
  State<AdereDashboardSaisiesS4Widget> createState() =>
      _AdereDashboardSaisiesS4WidgetState();
}

class _AdereDashboardSaisiesS4WidgetState
    extends State<AdereDashboardSaisiesS4Widget> {
  late AdereDashboardSaisiesS4Model _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => AdereDashboardSaisiesS4Model());

    logFirebaseEvent('screen_view',
        parameters: {'screen_name': 'ADERE_DASHBOARD_SAISIES_S4'});
    // On page load action.
    SchedulerBinding.instance.addPostFrameCallback((_) async {
      logFirebaseEvent('ADERE_DASHBOARD_SAISIES_S4_ADERE_DASHBOA');
      logFirebaseEvent('ADERE_DASHBOARD_SAISIES_S4_update_app_st');
                    ...
                    children: [
                            ...
                            child: Column(
                              ...
                              children: [
                                InkWell(
                                  ...
                                  onTap: () async {
                                    logFirebaseEvent(
                                        'ADERE_DASHBOARD_SAISIES_S4_Field_Contain');
                                    logFirebaseEvent(
                      ...
                      Padding(
                        ...
                        child: InkWell(
                          ...
                          onTap: () async {
                            logFirebaseEvent(
                                'ADERE_DASHBOARD_SAISIES_S4_Button_Contai');
                            ...
                            await SaisieSymptomsTable().insert({
                              'user': currentUserUid,
                              'illness': FFAppState().symptomMaladie,
                              'intensity': FFAppState().symptomIntensity,
                              'trigger': FFAppState().symptomTrigger,
                              'impact': FFAppState().symptomImpact,
                              'active': FFAppState().symptomBool,
                              'symptom': FFAppState().symptom,
                              'date': dateTimeFormat(
                                "dd/MM/yyyy",
                                _model.datePicked,
                                locale:
