...
import 'adere_dashboard_mes_services_model.dart';
export 'adere_dashboard_mes_services_model.dart';

class AdereDashboardMesServicesWidget extends StatefulWidget {
  const AdereDashboardMesServicesWidget({super.key});

  @override
  State<AdereDashboardMesServicesWidget> createState() =>
      _AdereDashboardMesServicesWidgetState();
}

class _AdereDashboardMesServicesWidgetState
    extends State<AdereDashboardMesServicesWidget> {
  late AdereDashboardMesServicesModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => AdereDashboardMesServicesModel());

    logFirebaseEvent('screen_view',
        parameters: {'screen_name': 'ADERE_DASHBOARD_MES_SERVICES'});
    // On page load action.
    SchedulerBinding.instance.addPostFrameCallback((_) async {
      logFirebaseEvent('ADERE_DASHBOARD_MES_SERVICES_ADERE_DASHB');
      logFirebaseEvent('ADERE_DASHBOARD_MES_SERVICES_update_app_');
                          ...
                          children: [
                            Padding(
                              ...
                              child: InkWell(
                                ...
                                onTap: () async {
                                  logFirebaseEvent(
                                      'ADERE_DASHBOARD_MES_SERVICES_Service_Con');
                                  logFirebaseEvent(
                                      'Service_Container_navigate_to');

                                  context
                                      .pushNamed('ADERE_DASHBOARD_MARKETPLACE');
                                },
                                child: Container(
                                  width: double.infinity,
                                  decoration: BoxDecoration(
                            ...
                            Padding(
                              ...
                              child: InkWell(
                                ...
                                onTap: () async {
                                  ...
                                  context.pushNamed('ADERE_DASHBOARD_REWARDS');
                                },
                                child: Container(
                                  width: double.infinity,
                                  decoration: BoxDecoration(
