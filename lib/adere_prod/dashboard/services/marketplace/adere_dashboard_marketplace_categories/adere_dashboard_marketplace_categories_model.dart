...
import 'adere_dashboard_marketplace_categories_widget.dart'
...
class AdereDashboardMarketplaceCategoriesModel
    extends FlutterFlowModel<AdereDashboardMarketplaceCategoriesWidget> {
  ...
  // Stores action output result for [Backend Call - API (GET products search)] action in TextField widget.
  ApiCallResponse? apiResultSearchProducts;
