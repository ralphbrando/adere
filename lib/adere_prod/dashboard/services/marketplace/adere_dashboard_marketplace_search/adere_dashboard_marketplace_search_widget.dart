...
import 'adere_dashboard_marketplace_search_model.dart';
export 'adere_dashboard_marketplace_search_model.dart';

class AdereDashboardMarketplaceSearchWidget extends StatefulWidget {
  const AdereDashboardMarketplaceSearchWidget({
    super.key,
  ...
  @override
  State<AdereDashboardMarketplaceSearchWidget> createState() =>
      _AdereDashboardMarketplaceSearchWidgetState();
}

class _AdereDashboardMarketplaceSearchWidgetState
    extends State<AdereDashboardMarketplaceSearchWidget> {
  late AdereDashboardMarketplaceSearchModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => AdereDashboardMarketplaceSearchModel());

    logFirebaseEvent('screen_view',
        parameters: {'screen_name': 'ADERE_DASHBOARD_MARKETPLACE_SEARCH'});
    // On page load action.
    SchedulerBinding.instance.addPostFrameCallback((_) async {
      logFirebaseEvent('ADERE_DASHBOARD_MARKETPLACE_SEARCH_ADERE');
      logFirebaseEvent('ADERE_DASHBOARD_MARKETPLACE_SEARCH_updat');
                        ...
                        child: Container(
                          ...
                          child: TextFormField(
                            ...
                            onChanged: (_) => EasyDebounce.debounce(
                              ...
                              () async {
                                logFirebaseEvent(
                                    'ADERE_DASHBOARD_MARKETPLACE_SEARCH_TextF');
                                  ...
                                  child: Row(
                                    ...
                                    children: [
                                      InkWell(
                                        ...
                                        onTap: () async {
                                          logFirebaseEvent(
                                              'ADERE_DASHBOARD_MARKETPLACE_SEARCH_Text_');
                                          logFirebaseEvent(
                                        ...
                                        return Row(
                                          ...
                                          children: List.generate(
                                            ...
                                            return InkWell(
                                              ...
                                              onTap: () async {
                                                logFirebaseEvent(
                                                    'ADERE_DASHBOARD_MARKETPLACE_SEARCH_Conta');
                                                logFirebaseEvent(
                                    ...
                                    Expanded(
                                      child: FutureBuilder<ApiCallResponse>(
                                        ...
                                        builder: (context, snapshot) {
                                          ...
                                          final productsGridViewGETProductsSearchResponse =
                                              snapshot.data!;

                                          return Builder(
                                            builder: (context) {
                                              final productsBySearch =
                                                  getJsonField(
                                                productsGridViewGETProductsSearchResponse
                                                    .jsonBody,
                                                r'''$.search_results''',
                                              ).toList();
                                              ...
                                              return GridView.builder(
                                                ...
                                                itemBuilder: (context,
                                                    productsBySearchIndex) {
                                                  final productsBySearchItem =
                                                      productsBySearch[
                                                          productsBySearchIndex];
                                                  return InkWell(
                                                    splashColor:
                                                    ...
                                                    onTap: () async {
                                                      logFirebaseEvent(
                                                          'ADERE_DASHBOARD_MARKETPLACE_SEARCH_Produ');
                                                      logFirebaseEvent(
                                                          'Product_Container_launch_u_r_l');
                                                      await launchURL(
                                                          getJsonField(
                                                        productsBySearchItem,
                                                        r'''$.link''',
                                                      ).toString());
                                                    },
                                                    child: Material(
