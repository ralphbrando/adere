...
import 'adere_armoire_widget.dart' show AdereArmoireWidget;
import 'package:flutter/material.dart';
import 'package:flutter/scheduler.dart';
import 'package:google_fonts/google_fonts.dart';
import 'package:provider/provider.dart';

class AdereArmoireModel extends FlutterFlowModel<AdereArmoireWidget> {
  ///  State fields for stateful widgets in this page.

  // Stores action output result for [Backend Call - Query Rows] action in ADERE_ARMOIRE widget.
  List<UserPackagesRow>? userpackageofcurrentuser;
