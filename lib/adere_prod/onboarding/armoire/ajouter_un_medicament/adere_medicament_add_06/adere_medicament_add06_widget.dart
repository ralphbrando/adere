...
import 'adere_medicament_add06_model.dart';
export 'adere_medicament_add06_model.dart';

class AdereMedicamentAdd06Widget extends StatefulWidget {
  const AdereMedicamentAdd06Widget({
    super.key,
    required this.body,
  });
  ...
  @override
  State<AdereMedicamentAdd06Widget> createState() =>
      _AdereMedicamentAdd06WidgetState();
}

class _AdereMedicamentAdd06WidgetState
    extends State<AdereMedicamentAdd06Widget> {
  late AdereMedicamentAdd06Model _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => AdereMedicamentAdd06Model());

    logFirebaseEvent('screen_view',
        parameters: {'screen_name': 'ADERE_MEDICAMENT_ADD_06'});
                        ...
                        children: [
                          Container(
                            ...
                            child: InkWell(
                              ...
                              onTap: () async {
                                logFirebaseEvent(
                                    'ADERE_MEDICAMENT_ADD_06_Text_movpauco_ON');
                    ...
                    children: [
                                    ...
                                    Expanded(
                                      child: Container(
                                        ...
                                        child: Column(
                                          ...
                                          children: [
                                            Text(
                                              'Sélectionner le nombre de boite délivrée et le nombre par boite :',
                      ...
                      Padding(
                        ...
                        child: InkWell(
                          ...
                          onTap: () async {
                            logFirebaseEvent(
                                'ADERE_MEDICAMENT_ADD_06_Button_Container');
                            ...
                            if (FFAppState().dose != null &&
                                FFAppState().dose != '') {
                              logFirebaseEvent('Button_Container_backend_call');
                              await UserPackagesTable().update(
                                data: {
                                  'boite_delivree': _model.dropDownValue1,
                                  'pills_par_boite': _model.dropDownValue2,
                            ...
                            FFAppState().juskafin = false;
                            FFAppState().boitedelivree = _model.dropDownValue1!;
                            safeSetState(() {});
                            logFirebaseEvent('Button_Container_navigate_to');

                            context.pushNamed(
                              'ADERE_MEDICAMENT_ADD_07',
                              queryParameters: {
                                'body': serializeParam(
                                  widget!.body,
                                  ParamType.JSON,
