...
import 'adere_medicament_add08_model.dart';
export 'adere_medicament_add08_model.dart';

class AdereMedicamentAdd08Widget extends StatefulWidget {
  const AdereMedicamentAdd08Widget({
    super.key,
    required this.body,
  });
  ...
  @override
  State<AdereMedicamentAdd08Widget> createState() =>
      _AdereMedicamentAdd08WidgetState();
}

class _AdereMedicamentAdd08WidgetState
    extends State<AdereMedicamentAdd08Widget> {
  late AdereMedicamentAdd08Model _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => AdereMedicamentAdd08Model());

    logFirebaseEvent('screen_view',
        parameters: {'screen_name': 'ADERE_MEDICAMENT_ADD_08'});
                        ...
                        children: [
                          Container(
                            ...
                            child: InkWell(
                              ...
                              onTap: () async {
                                logFirebaseEvent(
                                    'ADERE_MEDICAMENT_ADD_08_Text_4nyh5nxc_ON');
                    ...
                    children: [
                                  ...
                                  child: Column(
                                    ...
                                    children: [
                                      Container(
                                        ...
                                        decoration: BoxDecoration(),
                                        child:
                                            FutureBuilder<List<UserIllnessRow>>(
                      ...
                      Padding(
                        ...
                        child: InkWell(
                          ...
                          onTap: () async {
                            logFirebaseEvent(
                                'ADERE_MEDICAMENT_ADD_08_Button_Container');
                            ...
                            await UserPackagesTable().update(
                              data: {
                                'quelle_maladie': _model.dropDownValue,
                              },
