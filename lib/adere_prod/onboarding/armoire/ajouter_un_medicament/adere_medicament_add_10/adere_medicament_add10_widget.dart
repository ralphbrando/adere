...
import 'adere_medicament_add10_model.dart';
export 'adere_medicament_add10_model.dart';

class AdereMedicamentAdd10Widget extends StatefulWidget {
  const AdereMedicamentAdd10Widget({
    super.key,
    required this.body,
  });
  ...
  @override
  State<AdereMedicamentAdd10Widget> createState() =>
      _AdereMedicamentAdd10WidgetState();
}

class _AdereMedicamentAdd10WidgetState
    extends State<AdereMedicamentAdd10Widget> {
  late AdereMedicamentAdd10Model _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => AdereMedicamentAdd10Model());

    logFirebaseEvent('screen_view',
        parameters: {'screen_name': 'ADERE_MEDICAMENT_ADD_10'});
                        ...
                        children: [
                          Container(
                            ...
                            child: InkWell(
                              ...
                              onTap: () async {
                                logFirebaseEvent(
                                    'ADERE_MEDICAMENT_ADD_10_Text_zi979oqv_ON');
                    ...
                    children: [
                                ...
                                Expanded(
                                  child: Container(
                                    ...
                                    child: Column(
                                      ...
                                      children: [
                                        Text(
                                          'Votre médicament a été enregistré.',
                                          style: FlutterFlowTheme.of(context)
                                              .bodyMedium
                                              .override(
                                                fontFamily: 'Inter',
                                    ...
                                    Expanded(
                                      child: Container(
                                        ...
                                        child: Column(
                                          ...
                                          children: [
                                            Text(
                                              'Disponible : ${FFAppState().boitedelivree} boite(s)',
                                              textAlign: TextAlign.start,
                                              style: FlutterFlowTheme.of(
                                                      context)
                                                  .bodyMedium
                                ...
                                Expanded(
                                  child: Container(
                                    ...
                                    child: Column(
                                      ...
                                      children: [
                                        Text(
                                          'La gestion de vos médicaments sera disponible dans votre armoire à pharmacie à la fin du programme initial.',
                                          textAlign: TextAlign.start,
                                          style: FlutterFlowTheme.of(context)
                                              .bodyMedium
                                              .override(
                      ...
                      Padding(
                        ...
                        child: InkWell(
                          ...
                          onTap: () async {
                            logFirebaseEvent(
                                'ADERE_MEDICAMENT_ADD_10_Button_Container');
