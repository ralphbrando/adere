...
class LightModeTheme extends FlutterFlowTheme {
  ...
  late Color isabelline = Color(0xFFF0E9E3);
  late Color platinum = Color(0xFFECEBE9);
  late Color whiteSmoke = Color(0xFFF5F5F5);
  late Color ashGray = Color(0xFF9CA19B);
  late Color slateGray = Color(0xFF6F7D86);
  late Color jett = Color(0xFF383735);
  late Color columbiaBlue = Color(0xFFB8DDF0);
  late Color lightSkyBlue = Color(0xFF89CDFA);
  late Color cambridgeBlue = Color(0xFF80C09B);
  late Color naplesYellow = Color(0xFFF3D153);
  late Color persianOrange = Color(0xFFE68653);
  late Color eerieBlack = Color(0xFF23201E);
}
