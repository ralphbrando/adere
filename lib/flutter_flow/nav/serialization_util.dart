  ...
  try {
    ...
    switch (paramType) {
      ...
      case ParamType.SupabaseRow:
        ...
        switch (T) {
          case UserPackagesRow:
            return UserPackagesRow(data);
          case ParametersRaisonRow:
            return ParametersRaisonRow(data);
          case VoieAdministrationRow:
            return VoieAdministrationRow(data);
          case TriggersRow:
            return TriggersRow(data);
          case GalenicFormsRow:
            return GalenicFormsRow(data);
          case SaisieParametersRow:
            return SaisieParametersRow(data);
          case UserParameterRow:
            return UserParameterRow(data);
          case IllnessesRow:
            return IllnessesRow(data);
          case UserIllnessRow:
            return UserIllnessRow(data);
          case ProgrammesRow:
            return ProgrammesRow(data);
          case ImpactRow:
            return ImpactRow(data);
          case SaisieSymptomsRow:
            return SaisieSymptomsRow(data);
          case SaisieIntakesRow:
            return SaisieIntakesRow(data);
          case AlertTypesRow:
            return AlertTypesRow(data);
          case SymptomRow:
            return SymptomRow(data);
          case ParametersRow:
            return ParametersRow(data);
          case ParameterWhenRow:
            return ParameterWhenRow(data);
          case PackagesRow:
            return PackagesRow(data);
          case WikiCategoryRow:
            return WikiCategoryRow(data);
          case SaisieIntakesEventRow:
            return SaisieIntakesEventRow(data);
          case SaisieMoodsRow:
            return SaisieMoodsRow(data);
          case UsersRow:
            return UsersRow(data);
          case UserSymptomRow:
            return UserSymptomRow(data);
          case WikiPostsRow:
            return WikiPostsRow(data);
